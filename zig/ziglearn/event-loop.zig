...
// An event loop is a design pattern in which events are dispatched and/or
// waited upon. This will mean some kind of service or runtime that resumes
// suspended async frames when conditions are met. This is the most powerful
// and useful use case of Zig's async.
