        ...
        while (@bitCast(c_ulong, @as(c_long, i)) < (count -% @bitCast(c_ulong, @as(c_long, @as(c_int, 1))))) : (i += 1) {
            {
                ...
                while (@bitCast(c_ulong, @as(c_long, j)) < ((count -% @bitCast(c_ulong, @as(c_long, i))) -% @bitCast(c_ulong, @as(c_long, @as(c_int, 1))))) : (j += 1) {
                    if (array[@intCast(c_uint, j)] > array[@intCast(c_uint, j + @as(c_int, 1))]) {
                        var temp: c_int = array[@intCast(c_uint, j)];
                        array[@intCast(c_uint, j)] = array[@intCast(c_uint, j + @as(c_int, 1))];
                        array[@intCast(c_uint, j + @as(c_int, 1))] = temp;
                    }
                }
            }
        }
...
pub const offsetof = @compileError("TODO implement function '__builtin_offsetof' in std.c.builtins"); // /home/gitpod/zig/lib/include/stddef.h:104:9
pub const __llvm__ = @as(c_int, 1);
pub const __clang__ = @as(c_int, 1);
pub const __clang_major__ = @as(c_int, 12);
pub const __clang_minor__ = @as(c_int, 0);
pub const __clang_patchlevel__ = @as(c_int, 1);
pub const __clang_version__ = "12.0.1 (git@github.com:ziglang/zig-bootstrap.git b77bedc8895fc1ecfef4144f2f9c488f7f9e3a10)";
...
pub const __VERSION__ = "Clang 12.0.1 (git@github.com:ziglang/zig-bootstrap.git b77bedc8895fc1ecfef4144f2f9c488f7f9e3a10)";
